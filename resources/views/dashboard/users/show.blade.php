                        ...
                        <div class="card card-info card-outline">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input disabled="disabled" type="text" name="name" value="{{ $user->name }}"
                                           class="form-control"
                                           id="name">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input disabled="disabled" type="text" name="email" value="{{ $user->email }}"
                                           class="form-control"
                                           id="email">
                                </div>
                                <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-header border-0">
                                                ...
                                                <div class="card-tools">
                                                    ...
                                                    <button type="button"
                                                            class="btn d-none btn-sales-30-dayes btn-tool">
...
@push('scripts')
    ...
    <script>
        ...
        function ChartSales2YearsRequestAjex(month) {
            $.get("{{ route('dashboard.users.month',$user->id) }}?month=" + month, function (data) {
        ...
        function ChartSales30DayesRequestAjex(day) {
            $.get("{{ route('dashboard.users.day',$user->id) }}?day=" + day, function (data) {
